(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('verge'), require('mithril'), require('resize-observer-polyfill'), require('j2c')) :
  typeof define === 'function' && define.amd ? define(['verge', 'mithril', 'resize-observer-polyfill', 'j2c'], factory) :
  (global.polythene = factory(global.verge,global.m,global['resize-observer-polyfill'],global.j2c));
}(this, (function (verge,m,ResizeObserver,J2c) { 'use strict';

  verge = verge && verge.hasOwnProperty('default') ? verge['default'] : verge;
