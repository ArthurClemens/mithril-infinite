...
infinite.view = function (ctrl, opts) {
    ...
    function _ref() {
        ...
        ctrl.scrollWatchScrollingStateId = setTimeout(_ref2, SCROLL_WATCH_TIMER);

        // debounce updates while scrolling
        if (!ctrl.scrollWatchUpdateStateId) {
            ctrl.scrollWatchUpdateStateId = setTimeout(_ref3, SCROLL_WATCH_TIMER);
        }
    }

    var content = (0, _mithril2['default'])('div', {
        config: function config(el, inited, context) {
            var _ctrl$scrollView$classList;
            ...
            var classList1 = classList.join(' ').split(' ');
            (_ctrl$scrollView$classList = ctrl.scrollView.classList).add.apply(_ctrl$scrollView$classList, _toConsumableArray(classList1));
        ...
        'class': 'content'
    }, [opts.before ? (0, _mithril2['default'])('.before', {
    ...
    })), opts.after ? (0, _mithril2['default'])('.after', {
        config: function config(el) {
            // always update the natural size
            var size = infinite.getElementSize(el, opts.axis);
            if (size) {
    ...
    }, opts.after) : null]), (0, _mithril2['default'])('.paddingAfter', {
        style: Object.assign({}, opts.axis === 'x' ? {
...
window.onresize = function () {
    ...
    resizeTimer = setTimeout(_ref4, RESIZE_TIMER);
};
