...
infinite.view = (ctrl, opts) => {
    ...
    const classList = ['scroll-view', 'scroll-view-' + (opts.axis || 'y'), opts.class || ''];
    ...
    const isLastPageVisible = maxPages ? infinite.isPageInViewport(maxPages, opts.axis, state, ctrl.scrollView) : true;
